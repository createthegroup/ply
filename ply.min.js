...
function(a,c,h,i){return e.call(d.extend({},f.fn[b].impl),b,a,c,h,i)};this.fn[b].impl=d.extend({},i,a)},register:function(b,a){a=a&&typeof a==="object"?a:{};if(Ply.config.ui.onRegister&&typeof Ply.config.ui.onRegister==="function")Ply.config.ui.onRegister(b,a);if(!a.view)a.view=Ply.config.ui.selectorGenerator(b),Ply.core.log("No view name supplied, implying: "+a.view);return this.start(b,a)},start:function(b,a){Ply.core.log("trying start: "+b,"info");try{return this.fn[b](d(a.view),a.options,a.data,
a.delegate)}catch(e){if(Ply.core.log(b+" failed to start."),Ply.core.error(e,1),Ply.core.debugOn)throw e;}}}}(jQuery);
