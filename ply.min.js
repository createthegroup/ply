...
Ply.read=function(){return{add:function(c,b){if(typeof c==="object")for(var a in c)if(c.hasOwnProperty(a))return Ply.read.add(a,c[a]);this[c]=function(a,c,f){return Ply.ajax.request({url:b,type:"GET",data:a},c,f)}}}}();if(!Object.create)Object.create=function(c){function b(){}if(arguments.length>1)throw Error("Object.create implementation only accepts first parameter.");b.prototype=c;return new b};
...
this.fn[a]=function(d,c,f,j){return b.call(Object.create(g.fn[a].impl),a,d,c,f,j)};this.fn[a].impl=c.extend(Object.create(f),d);this.fn[a].impl.read=Ply.read[a]},register:function(a,b){var c=Ply.config.ui,b=b&&typeof b==="object"?b:{};if(c.onRegister&&typeof c.onRegister==="function")c.onRegister(a,b);if(!b.view)b.view=c.selectorGenerator(a),Ply.core.log("No view name supplied, implying: "+b.view);return this.start(a,b)},start:function(a,b){Ply.core.log("trying start: "+a,"info");try{return this.fn[a](c(b.view),
