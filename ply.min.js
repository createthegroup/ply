...
Ply.core=function(){var d={},b=!1;return{notify:function(a,c,b){var f=d[a],g=0,e=f.length;for(f||(d[a]=[]);g<e;g++)f[g].handler.apply(f[g].listener,[a,c,b])},listen:function(a,c,b){var f=d[a],g=a.split(/\s/),e=g.length,i=0;if(e>1)for(;i<e;i++)this.listen(g[i],c,b);else f||(d[a]=[]),f.push({handler:c,listener:b})},log:function(a,c){if(b&&window.console)switch(c){case "warn":console.warn(a);break;case "info":console.info(a);break;default:console.log(a)}},error:function(a,c){if(Ply.config.core.onError&&
typeof Ply.config.core.onError==="function")Ply.config.core.onError(a,c);else throw a;},debug:function(a){b=a||!0;this.log("debugging...","info");this.debugOn=!0;this.debugOn=!1},debugOn:!!b}}(jQuery);
