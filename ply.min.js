...
Ply.read=function(){return{add:function(c,b){if(typeof c==="object")for(n in c)if(c.hasOwnProperty(n))return Ply.read.add(n,c[n]);this[c]=function(a,d,c){return Ply.ajax.request({url:b,type:"GET",data:a},d,c)}}}}();if(!Object.create)Object.create=function(c){function b(){}if(arguments.length>1)throw Error("Object.create implementation only accepts first parameter.");b.prototype=c;return new b};
