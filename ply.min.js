...
{name:a.name,description:a.description,message:a.message,lineNumber:a.lineNumber,stackTrace:a.stack});b>1&&alert("An error has occurred. Please refresh your browser")},debug:function(a){b=a||!0;this.log("debugging...","info");this.debugOn=!0},debugOn:!!b}}(jQuery);
